...
class InvoiceView: UIView {
    ...
    private func layoutView() {
        ...
        nameLabel.text = "이름 : \(parcelInformation.receiverInformation.receiverName.getValue())"
        
        let mobileLabel: UILabel = UILabel()
        mobileLabel.textColor = .black
        mobileLabel.font = .preferredFont(forTextStyle: .largeTitle)
        mobileLabel.text = "전화 : \(parcelInformation.receiverInformation.receiverMobile.getValue())"
        
        let addressLabel: UILabel = UILabel()
        addressLabel.textColor = .black
        addressLabel.font = .preferredFont(forTextStyle: .largeTitle)
        addressLabel.text = "주소 : \(parcelInformation.receiverInformation.address.getValue())"
